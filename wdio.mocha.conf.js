...
exports.config = {
    ...
    onPrepare: function () {
        reportAggregator = new ReportAggregator({
            outputDir: './reports/html-reports/',
            filename: 'master-report-mocha.html', // nombre del HTML final
    ...
    onComplete: async function () {
        try {
            ...
            console.log(
                '✅ HTML Nice Report generado en: reports/html-reports/master-report-mocha.html'
            );
        } catch (err) {
